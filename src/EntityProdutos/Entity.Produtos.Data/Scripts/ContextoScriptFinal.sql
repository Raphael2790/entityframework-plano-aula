...
CREATE TABLE `fornecedores` (
    ...
    CONSTRAINT `FK_fornecedores_enderecos_enderecoid` FOREIGN KEY (`endereco_id`) REFERENCES `enderecos` (`id`) ON DELETE CASCADE
) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
INSERT INTO `categorias` (`id`, `descricao`)
VALUES (2, 'Eletrodomésticos');


CREATE INDEX `IX_PK_categorias` ON `categorias` (`id`);
